...
const Footer = () => {
  return (
    <footer className="h-full w-full relative top-0 bg-slate-900 text-white py-12 px-4 md:px-12 border-t border-white">
      ...
      <div className="border-t border-gray-700 mt-6 pt-4 text-center text-sm text-gray-400">
        © {new Date().getFullYear()} Rishav Sinha. All rights reserved.
      </div>
    </footer>
  );
};
